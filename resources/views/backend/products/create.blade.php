        ...
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            <input type="number" step="0.01" min="0" class="form-control"
              placeholder="{{ __('Enter price') }}" name="price" value="{{ old('price') }}" required>
          </div>
          <!-- <div class="mb-3 col-md-6">
          ...
          <div class="mb-3 col-md-6">
            ...
            <input type="number" step="0.01" min="0" class="form-control"
              placeholder="{{ __('Enter purchase Price') }}" name="purchase_price" value="{{ old('purchase_price') }}" required>
          </div>
          <div class="mb-3 col-md-6">
            ...
            <input type="number" step="0.01" min="0" class="form-control"
              placeholder="{{ __('Enter discount') }}" name="discount" value="{{ old('discount') }}">
          </div>
          <div class="mb-3 col-md-6">
          ...
          <div class="mb-3 col-md-6">
            ...
            <div class="input-group date" id="reservationdate" data-target-input="nearest">
              <input type="text" placeholder="{{ __('Enter product expire date') }}" class="form-control datetimepicker-input" data-target="#reservationdate" name="expire_date" value="{{ old('expire_date') }}" />
